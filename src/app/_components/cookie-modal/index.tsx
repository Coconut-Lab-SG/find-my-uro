...
export function CookieModal() {
  const { checkbox, showModal, showManagePanel, setShowManagePanel, handleCheckboxChange, acceptPartialCookies, acceptAllCookies, closeModal } =
    useCookieModal()
        ...
        {!showManagePanel ? (
          <div className="flex flex-col gap-4">
            <p className="leading-5">
              We use cookies to personalize content and ads, to provide social media features and to analyze our traffic. We also share information
            ...
            <div className="flex items-center gap-2 justify-center">
              <Button className="bg-[#f6a404] rounded-lg h-[50px] italic px-7 hover:bg-orange-500" onClick={acceptAllCookies}>
                Accept All
              </Button>
              <Button className="bg-[#dadada] rounded-lg h-[50px] text-black px-7 hover:bg-gray-300" onClick={() => setShowManagePanel(true)}>
                Manage
              </Button>
            </div>
          </div>
          ...
          <div className="flex items-center gap-x-4">
            <AccordionItem value="item-1" className="flex-1">
              ...
              <AccordionContent className="pt-3">
                Necessary cookies help make a website usable by enabling basic functions like page navigation and access to secure areas of the
        ...
        <Accordion type="single" collapsible className="w-full">
          <div className="flex items-center gap-x-4">
            <AccordionItem value="item-3" className="flex-1">
              ...
              <AccordionContent className="pt-3">
                Preference cookies enable a website to remember information that changes the way the website behaves or looks, like your preferred
        ...
        <Accordion type="single" collapsible className="w-full">
          <div className="flex items-center gap-x-4">
            ...
            <Checkbox
              id="marketing"
              name="marketing"
              checked={checkbox.marketing_cookie}
              onCheckedChange={handleCheckboxChange('marketing_cookie')}
            />
          </div>
        </Accordion>
      </div>
      <div className="flex items-center gap-2 justify-center">
        <Button className="bg-[#dadada] rounded-lg h-[50px] text-black px-7 hover:bg-gray-300" onClick={acceptPartialCookies}>
          Accept Selection
        </Button>
        <Button className="bg-[#f6a404] rounded-lg h-[50px] italic px-7 hover:bg-orange-500" onClick={acceptAllCookies}>
          Accept All
