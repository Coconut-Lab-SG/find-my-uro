  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between gap-3">
        <Button variant="default" className="rounded-lg w-[135px]" style={{ background: 'linear-gradient(96.65deg, #b20000 0%, #ff7c52 95.82%)' }}>
          <Heart size="16" />
        </Button>
        <Button variant="default" className="rounded-lg w-[135px]" style={{ background: 'linear-gradient(90.49deg,#243b6c .28%,#432f91 96.69%)' }}>
          <Star size="16" />
        </Button>
